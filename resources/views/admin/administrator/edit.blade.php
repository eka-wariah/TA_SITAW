          ...
          <form action="" method="post">
            ...
            <div class="card-body">
                <div class="mb-4 row align-items-center">
                  ...
                  <option hidden value="{{ $editadministrators->adm_name_id }}">{{ $editadministrators->user->name }}</option>
              ...
              <div class="mb-4 row align-items-center">
                <label for="Select" class="form-label col-sm-3 col-form-label">Nama</label>
                <div class="col-sm-9">
                <select id="Select" name="scope_id" class="form-control" required>
                <option hidden value="{{ $editadministrators->adm_scope_management_id }}">{{ $editadministrators->scope_categories->scs_level }} {{$editadministrators->scope_categories->scs_number}}</option>
                ...
                {{-- <div class="mb-4 row align-items-center">
                    ...
                    <option hidden  value="{{ $editadministrators->adm_management_scope_id }}">{{ $editadministrators->scope_categories->scs_level }} {{$editadministrators->scope_categories->scs_number}}</option>
                    @foreach ($scope_categories as $scope_categories)
                      <option value="{{ $scope_categories->scs_id }}">{{ $scope_categories->scs_level }} {{$scope_categories->scs_number}}</option>
                    @endforeach
                    </select>
