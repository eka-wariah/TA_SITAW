        ...
        <div class="card">
            <div class="card-body">
                <div class="mb-5 position-relative">
                    ...
                    <a href="/admin/administrator/create" class="btn btn-primary position-absolute top-0 end-0">Tambah Kategori</a>
                </div>
                ...
                <div class="table-responsive">
                    <table id="file_export" class="table w-100 table-striped table-bordered display text-nowrap">
                        ...
                        <tbody>
                            ...
                            @endforeach --}}
                            <!-- end row --> 
                            @foreach ($administrators as $no=> $administrators)
                            <tr>
                                ...
                                <td>
                                    <a href="/admin/administrator/{{$administrators->adm_id}}/edit" class="btn btn-primary">Edit</a>
                                    <a href="/admin/administrator/{{$administrators->adm_id}}/destroy" class="btn btn-danger" data-confirm-delete="true">Delete</a>
                                    </form>
