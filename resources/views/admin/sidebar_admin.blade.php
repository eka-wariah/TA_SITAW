          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="/admin/complaint" aria-expanded="false">
                ...
                <span class="hide-menu">Kelola Data Pengaduan</span>
              </a>
            </li>
            <li class="sidebar-item">
            ...
            <li class="nav-small-cap">
              <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
              <span class="hide-menu">Pemasukan Dan Pengeluaran</span>
            </li>
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="/admin/trash_category" aria-expanded="false">
                <span>
                  <i class="ti ti-archive"></i>
                </span>
                <span class="hide-menu">Kelola Kategori Sampah</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="/admin/payment_category" aria-expanded="false">
                ...
                <span class="hide-menu">Kelola Kategori Pembayaran</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="/admin/scope_category" aria-expanded="false">
                <span>
                  <i class="ti ti-map"></i>
                </span>
                <span class="hide-menu">Kelola Kategori Ruang Lingkup</span>
              </a>
            </li>
            {{-- <li class="sidebar-item">
